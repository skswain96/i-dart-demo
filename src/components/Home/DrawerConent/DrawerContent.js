...
const DrawerContent = ({ data, updateData, getScripValues, handleCloseSideDrawer }) => {
        ...
        <Grid container direction="column" justify="center">
            <Grid item xs container justify="flex-end">
                <i
                    ...
                    style={{ cursor: 'pointer', position: "absolute", right: 10, top: 10, fontSize: 20 }}
            ...
            <Grid item xs container className={styles.marginBottom}>
                <TextField
                    onChange={e =>
                        setPercentProfileValue(e.target.value)
                    }
                    variant="outlined"
            ...
            <Grid item xs container className={styles.marginBottom}>
                <TextField
                    onChange={e =>
                        setUnrealizedPL(e.target.value)
                    }
                    variant="outlined"
